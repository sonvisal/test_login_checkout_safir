Feature: Test add favorite page
  ...
  Scenario: Test favorite success
    ...
    Then I click on the button "#news > div > div.news-home > ul > li:nth-child(1) > div > div.caption > div.rating > a.heart.pull-right.unlike.unlike563feda701f64d594be68747 > span"
